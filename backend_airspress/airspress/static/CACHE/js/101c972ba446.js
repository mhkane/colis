...
var dateTime=day+'/'+month+'/'+year+' '+hour+':'+minute+':'+second;return dateTime;};window.onload=function(){var ref=new Firebase("https://radiant-torch-2520.firebaseio.com/data/directMessaging/messages/9lTLf3GPg1-75hu5oVFdl");var AUTH_TOKEN="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpYXQiOjE0MzEzNDczMzAsImQiOnsic291cmNlX2lkIjoiOWxUTGYzR1BnMS03NWh1NW9WRmRsIiwic291cmNlIjoiY2hhdCIsInVzZXJfaWQiOiI5bFRMZjNHUGcxIiwidWlkIjoiY3VzdG9tOjlsVExmM0dQZzEifSwidiI6MH0.qrspg4ISjpzLjB8x61bswEKOshRf2ZzTFp1-t2g57HQ";ref.unauth();ref.authWithCustomToken(AUTH_TOKEN,function(error,authData){if(error){console.log("Login Failed!",error);}else{console.log("Login Succeeded!",authData);}});document.getElementById("WrapperConversation1").style.maxHeight=(this.innerHeight-80)+'px';document.getElementById("WrapperConversation1").style.overflow="auto";document.getElementById('Conversation1').scrollTop=document.getElementById('Conversation1').scrollHeight
