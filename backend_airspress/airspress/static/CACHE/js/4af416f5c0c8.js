...
var urlAction="/account/oQ5Z5OlNiD/deals/"
var dealCheck=true;var payload={text:messageText,origin:sender,target:receiver,action:urlAction,isdeal:dealCheck,activityId:"oQ5Z5OlNiD"};$.ajax({type:'POST',url:"/account/talk/anyone/",data:payload,success:function(data,status,xhr){console.log('Notification sent !');}});}
