...
var dateTime=day+'/'+month+'/'+year+' '+hour+':'+minute+':'+second;return dateTime;};window.onload=function(){var ref=new Firebase("https://radiant-torch-2520.firebaseio.com/data/airdeals/messages/TaYggVm97w");var ref2=new Firebase("https://radiant-torch-2520.firebaseio.com/data/directMessaging/conversations/");var AUTH_TOKEN="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpYXQiOjE0MzI3Njg0ODMsImQiOnsic291cmNlX2lkIjoiVGFZZ2dWbTk3dyIsInNvdXJjZSI6ImRlYWxzIiwidXNlcl9pZCI6IkptenFmdExDTDciLCJ1aWQiOiJjdXN0b206Sm16cWZ0TENMNyJ9LCJ2IjowfQ.kaw6H56fy7_FTILbT2y-QvR6Vl0WGBFISuZVVWQ9UPk";ref.unauth();ref.authWithCustomToken(AUTH_TOKEN,function(error,authData){if(error){console.log("Login Failed!",error);}else{console.log("Login Succeeded!",authData);}});ref2.authWithCustomToken(AUTH_TOKEN,function(error,authData){if(error){console.log("Inbox Failed!",error);}else{console.log("Inbox Succeeded!",authData);}});document.getElementById('SendMessage1').onclick=function(e){e.preventDefault();var newMessageText=document.getElementById('NewMessage1').value;if(newMessageText!==""){ref.push({"sender":"JmzqftLCL7","text":newMessageText,"pub_date":getDateTime()});ref2.update({"inbox":{"senderId":"JmzqftLCL7","senderName":"mohamed.coulibali.1@ulaval.ca","text":newMessageText,"pub_date":Firebase.ServerValue.TIMESTAMP}});document.getElementById('WrapperConversation1').scrollIntoView(false);document.getElementById('NewMessage1').value='';}};document.getElementById('NewMessage1').onkeydown=function Shidori(e){if(e.keyCode==13||e.which==13){e.preventDefault();var newMessageText=document.getElementById('NewMessage1').value;if(newMessageText!==""){ref.push({"sender":"JmzqftLCL7","text":newMessageText,"pub_date":getDateTime()});ref2.update({"inbox":{"senderId":"JmzqftLCL7","senderName":"mohamed.coulibali.1@ulaval.ca","text":newMessageText,"pub_date":Firebase.ServerValue.TIMESTAMP}});document.getElementById('WrapperConversation1').scrollIntoView(false);document.getElementById('NewMessage1').value='';}}};ref.limitToLast(10).on("child_added",function(snapshot){var newMessage=snapshot.val();var conversation=document.getElementById('Conversation1');var wrapper=document.getElementById('WrapperConversation1');var snippet='';var part1='<div class="conversation-item item-left clearfix">\
